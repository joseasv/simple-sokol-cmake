...
static struct {
    ...
    sg_sampler smp;
    sg_view view_diffuse; // Legacy API
...
static void init(void)
{
    ...
    // 1. Cargar Imagen y Crear Sampler
...
static void frame(void)
{
    ...
    fs_params.mat_specular = HMM_V3(0.5f, 0.5f, 0.5f);
    fs_params.mat_shininess = 32.0f;

    // FIX: sg_apply_uniforms (2 argumentos)
...
sapp_desc sokol_main(int argc, char* argv[])
{
    ...
    desc.width = 800;
    desc.height = 600;
    desc.window_title = "14 - Mapa Difuso";
    desc.logger.func = slog_func;
    return desc;
}